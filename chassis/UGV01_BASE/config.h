...
// WIFI_STA settings.
const char* STA_SSID = "HomeWifi2";
const char* STA_PWD  = "Susan3290";
...
void getIMU(){
  ...
  IMU_Roll  = round(stAngles.fRoll*100)/100;
  IMU_Pitch = round(stAngles.fPitch*100)/100;
  IMU_Yaw   = round(stAngles.fYaw*100)/100;
